...
export class DemandeEntentePrealableUpdateComponent implements OnInit {
    private _demandeEntentePrealable: IDemandeEntentePrealable;
    isSaving: boolean;
    ...
    get demandeEntentePrealable() {
        return this._demandeEntentePrealable;
    }

    set demandeEntentePrealable(demandeEntentePrealable: IDemandeEntentePrealable) {
        this._demandeEntentePrealable = demandeEntentePrealable;
    }
}
