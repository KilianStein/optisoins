...
export class EtatRecapitulatifUpdateComponent implements OnInit {
    private _etatRecapitulatif: IEtatRecapitulatif;
    isSaving: boolean;
    ...
    get etatRecapitulatif() {
        return this._etatRecapitulatif;
    }

    set etatRecapitulatif(etatRecapitulatif: IEtatRecapitulatif) {
        this._etatRecapitulatif = etatRecapitulatif;
    }
}
