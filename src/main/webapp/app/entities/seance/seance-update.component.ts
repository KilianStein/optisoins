...
export class SeanceUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.seance.dateDebut = moment(this.dateDebut, DATE_TIME_FORMAT);
        this.seance.dateFin = moment(this.dateFin, DATE_TIME_FORMAT);
    ...
    set seance(seance: ISeance) {
        this._seance = seance;
        this.dateDebut = moment(seance.dateDebut).format(DATE_TIME_FORMAT);
        this.dateFin = moment(seance.dateFin).format(DATE_TIME_FORMAT);
    }
}
