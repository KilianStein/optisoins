...
public class Orthophoniste implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "orthophoniste_telephones",
               joinColumns = @JoinColumn(name = "orthophonistes_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "telephones_id", referencedColumnName = "id"))
    private Set<Telephone> telephones = new HashSet<>();

    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "orthophoniste_adresses",
               joinColumns = @JoinColumn(name = "orthophonistes_id", referencedColumnName = "id"),
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "orthophoniste_courriels",
               joinColumns = @JoinColumn(name = "orthophonistes_id", referencedColumnName = "id"),
