    ...
    describe('Medecin Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/medecins';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Medecin', () => {
                service.create(new Medecin(null)).subscribe(received => {
            ...
            it('should update a Medecin', () => {
                service.update(new Medecin(123)).subscribe(received => {
