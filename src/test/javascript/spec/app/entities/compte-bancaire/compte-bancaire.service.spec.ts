    ...
    describe('CompteBancaire Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/compte-bancaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CompteBancaire', () => {
                service.create(new CompteBancaire(null)).subscribe(received => {
            ...
            it('should update a CompteBancaire', () => {
                service.update(new CompteBancaire(123)).subscribe(received => {
            ...
            it('should return a CompteBancaire', () => {
            ...
            it('should return a list of CompteBancaire', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CompteBancaire(123)]);
            });
