    ...
    describe('Ordonnance Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ordonnances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Ordonnance', () => {
                service.create(new Ordonnance(null)).subscribe(received => {
            ...
            it('should update a Ordonnance', () => {
                service.update(new Ordonnance(123)).subscribe(received => {
