    ...
    describe('Seance Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/seances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Seance', () => {
                service.create(new Seance(null)).subscribe(received => {
            ...
            it('should update a Seance', () => {
                service.update(new Seance(123)).subscribe(received => {
