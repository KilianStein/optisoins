    ...
    describe('PriseEnCharge Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a PriseEnCharge', () => {
                service.create(new PriseEnCharge(null)).subscribe(received => {
            ...
            it('should update a PriseEnCharge', () => {
                service.update(new PriseEnCharge(123)).subscribe(received => {
            ...
            it('should return a PriseEnCharge', () => {
            ...
            it('should return a list of PriseEnCharge', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PriseEnCharge(123)]);
            });
