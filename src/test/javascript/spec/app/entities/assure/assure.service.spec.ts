    ...
    describe('Assure Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/assures';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Assure', () => {
                service.create(new Assure(null)).subscribe(received => {
            ...
            it('should update a Assure', () => {
                service.update(new Assure(123)).subscribe(received => {
