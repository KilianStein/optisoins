    ...
    describe('Courriel Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/courriels';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Courriel', () => {
                service.create(new Courriel(null)).subscribe(received => {
            ...
            it('should update a Courriel', () => {
                service.update(new Courriel(123)).subscribe(received => {
